        ...
        <div class="page-wrapper">
            ...
            <div class="content-wrapper">
                ...
                ?>
                    <div class="content">
                        <!-- Top -->
                        <form id="editAdmin" action="editAdmin.php" method="POST" enctype="multipart/form-data">
                            <div class="card card-body">
                                ...
                                <div class="form-footer">
                                    <button class="btn btn-primary btn-pill" name="editAdmin" id="editbutton" type="submit" disabled>Edit</button>
            ...
            <script>
                $(document).ready(function() {
                    $('#editAdmin').on('input change', function() {
